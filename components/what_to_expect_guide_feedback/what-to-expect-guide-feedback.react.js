...
import Button from '../details_feedback/child_components/button/details_feedback_widget_button.react';
import Fieldset from '../details_feedback/child_components/fieldset/details_feedback_fieldset.react';
import Comment from '../details_feedback/child_components/comment/details_feedback_comment.react';
import { Data } from '../details_feedback/data';
import Message from '../details_feedback/child_components/message/details_feedback_message.react';

import '../details_feedback/style.scss';
          ...
          <form onSubmit={this.handleSubmit}>
            ...
            {displayCommentBox && (
              <Fieldset
                id="no_fieldset"
                legendText={
                  guideHelpful ? noFieldsetData.legend : yesFieldsetData.legend
                }
                ...
                <Comment
                  ...
                  commentLabel={
                    guideHelpful
                      ? noFieldsetData.commentData.commentLabel
                      : yesFieldsetData.commentData.commentLabel
                  }
                  commentWarning={
                    guideHelpful
                      ? noFieldsetData.commentData.commentWarning
                      : yesFieldsetData.commentData.commentWarning
                  }
